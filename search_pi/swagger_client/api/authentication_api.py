...
class AuthenticationApi(object):
    ...
    def auth_controller_login_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='LoginAckDto',  # noqa: E501
    ...
    def auth_controller_register(self, body, **kwargs):  # noqa: E501
        """auth_controller_register  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.auth_controller_register(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AuthDto body: (required)
        :return: LoginAckDto
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.auth_controller_register_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.auth_controller_register_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def auth_controller_register_with_http_info(self, body, **kwargs):  # noqa: E501
        """auth_controller_register  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.auth_controller_register_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method auth_controller_register" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `auth_controller_register`")  # noqa: E501
